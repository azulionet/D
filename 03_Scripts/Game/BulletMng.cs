...
public class BulletMng : MonoBehaviour, ICleanUp
{
	...
	public Bullet AddShot(int a_nLayer, eBullet a_eBulletID, ST_AttackInfo a_refAtk, Vector3 a_VcFirstPos, Vector3 a_VcDir, Character a_refTarget = null)
	{
